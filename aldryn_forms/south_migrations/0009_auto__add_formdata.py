...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_forms_formdata', (
        ...
        db.send_create_signal(u'aldryn_forms', ['FormData'])

        # Adding M2M table for field people_notified on 'FormData'
        m2m_table_name = db.shorten_name(u'aldryn_forms_formdata_people_notified')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('formdata', models.ForeignKey(orm[u'aldryn_forms.formdata'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['formdata_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'FormData'
        db.delete_table(u'aldryn_forms_formdata')

        # Removing M2M table for field people_notified on 'FormData'
        db.delete_table(db.shorten_name(u'aldryn_forms_formdata_people_notified'))
