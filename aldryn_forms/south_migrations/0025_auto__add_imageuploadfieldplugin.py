...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageUploadFieldPlugin'
        db.create_table(u'aldryn_forms_imageuploadfieldplugin', (
            ...
            ('upload_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'])),
            ('max_size', self.gf('sizefield.models.FileSizeField')(null=True, blank=True)),
            ('max_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('max_height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'aldryn_forms', ['ImageUploadFieldPlugin'])


    def backwards(self, orm):
        # Deleting model 'ImageUploadFieldPlugin'
        db.delete_table(u'aldryn_forms_imageuploadfieldplugin')
