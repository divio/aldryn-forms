...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldsetPlugin.html_class'
        db.add_column(u'cmsplugin_fieldsetplugin', 'html_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'FormPlugin.html_class'
        db.add_column(u'cmsplugin_formplugin', 'html_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ButtonPlugin.input_html_class'
        db.add_column(u'cmsplugin_buttonplugin', 'input_html_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FieldsetPlugin.html_class'
        db.delete_column(u'cmsplugin_fieldsetplugin', 'html_class')

        # Deleting field 'FormPlugin.html_class'
        db.delete_column(u'cmsplugin_formplugin', 'html_class')

        # Deleting field 'ButtonPlugin.input_html_class'
        db.delete_column(u'cmsplugin_buttonplugin', 'input_html_class')
    ...
    models = {
        u'aldryn_forms.buttonplugin': {
            ...
            'input_html_class': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        u'aldryn_forms.fieldsetplugin': {
            ...
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'html_class': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
