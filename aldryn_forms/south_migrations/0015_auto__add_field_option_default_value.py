...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Option.default_value'
        db.add_column(u'aldryn_forms_option', 'default_value',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.default_value'
        db.delete_column(u'aldryn_forms_option', 'default_value')
