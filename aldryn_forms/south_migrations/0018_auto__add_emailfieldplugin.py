...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailFieldPlugin'
        db.create_table(u'aldryn_forms_emailfieldplugin', (
            ...
            ('email_send_notification', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'aldryn_forms', ['EmailFieldPlugin'])


    def backwards(self, orm):
        # Deleting model 'EmailFieldPlugin'
        db.delete_table(u'aldryn_forms_emailfieldplugin')
