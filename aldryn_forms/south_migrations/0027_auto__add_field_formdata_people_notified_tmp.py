...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormData.people_notified_tmp'
        db.add_column(u'aldryn_forms_formdata', 'people_notified_tmp',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormData.people_notified_tmp'
        db.delete_column(u'aldryn_forms_formdata', 'people_notified_tmp')
