...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailFieldPlugin.email_body'
        db.add_column(u'aldryn_forms_emailfieldplugin', 'email_body',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailFieldPlugin.email_body'
        db.delete_column(u'aldryn_forms_emailfieldplugin', 'email_body')
