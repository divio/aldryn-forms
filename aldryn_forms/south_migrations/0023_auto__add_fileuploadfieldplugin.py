...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FileUploadFieldPlugin'
        db.create_table(u'aldryn_forms_fileuploadfieldplugin', (
        ...
        db.send_create_signal(u'aldryn_forms', ['FileUploadFieldPlugin'])


    def backwards(self, orm):
        # Deleting model 'FileUploadFieldPlugin'
        db.delete_table(u'aldryn_forms_fileuploadfieldplugin')
    ...
    models = {
        ...
        u'aldryn_forms.fileuploadfieldplugin': {
            ...
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'required_message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'upload_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Folder']"})
        },
