...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaptchaField'
        db.create_table(u'cmsplugin_captchafield', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'aldryn_forms', ['CaptchaField'])


    def backwards(self, orm):
        # Deleting model 'CaptchaField'
        db.delete_table(u'cmsplugin_captchafield')
    ...
    models = {
        ...
        u'aldryn_forms.captchafield': {
            'Meta': {'object_name': 'CaptchaField', 'db_table': "u'cmsplugin_captchafield'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
