...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormData.language'
        db.add_column(u'aldryn_forms_formdata', 'language',
                      self.gf('django.db.models.fields.CharField')(default=settings.LANGUAGE_CODE, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormData.language'
        db.delete_column(u'aldryn_forms_formdata', 'language')
