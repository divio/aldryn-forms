...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FieldsetPlugin'
        db.create_table(u'cmsplugin_fieldsetplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('legend', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'aldryn_forms', ['FieldsetPlugin'])


    def backwards(self, orm):
        # Deleting model 'FieldsetPlugin'
        db.delete_table(u'cmsplugin_fieldsetplugin')
    ...
    models = {
        ...
        u'aldryn_forms.fieldsetplugin': {
            ...
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'legend': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
