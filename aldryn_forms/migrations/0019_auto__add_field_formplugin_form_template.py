...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormPlugin.form_template'
        db.add_column(u'aldryn_forms_formplugin', 'form_template',
                      self.gf('django.db.models.fields.CharField')(default='aldryn_forms/form.html', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormPlugin.form_template'
        db.delete_column(u'aldryn_forms_formplugin', 'form_template')
