...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldPlugin.required_message'
        db.add_column(u'cmsplugin_fieldplugin', 'required_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FieldPlugin.required_message'
        db.delete_column(u'cmsplugin_fieldplugin', 'required_message')
