...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'people_notified_tmp' to 'people_notified'
        db.rename_column(u'aldryn_forms_formdata', 'people_notified_tmp', 'people_notified')

    def backwards(self, orm):
        # Renaming field 'people_notified' to 'people_notified_tmp'
        db.rename_column(u'aldryn_forms_formdata', 'people_notified', 'people_notified_tmp')
