...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'FieldsetPlugin.html_class'
        db.rename_column(u'cmsplugin_fieldsetplugin', 'html_class', 'custom_classes')

        # Renaming field 'FormPlugin.html_class'
        db.rename_column(u'cmsplugin_formplugin', 'html_class', 'custom_classes')

        # Renaming field 'FieldPlugin.input_html_class'
        db.rename_column(u'cmsplugin_fieldplugin', 'input_html_class', 'custom_classes')

        # Renaming field 'ButtonPlugin.input_html_class'
        db.rename_column(u'cmsplugin_buttonplugin', 'input_html_class', 'custom_classes')

        # Renaming field 'TextAreaFieldPlugin.input_html_class'
        db.rename_column(u'cmsplugin_textareafieldplugin', 'input_html_class', 'custom_classes')


    def backwards(self, orm):
        # Renaming field 'FieldsetPlugin.custom_classes'
        db.rename_column(u'cmsplugin_fieldsetplugin', 'custom_classes', 'html_class')

        # Renaming field 'FormPlugin.custom_classes'
        db.rename_column(u'cmsplugin_formplugin', 'custom_classes', 'html_class')

        # Renaming field 'FieldPlugin.custom_classes'
        db.rename_column(u'cmsplugin_fieldplugin', 'custom_classes', 'input_html_class')

        # Renaming field 'ButtonPlugin.custom_classes'
        db.rename_column(u'cmsplugin_buttonplugin', 'custom_classes', 'input_html_class')

        # Renaming field 'TextAreaFieldPlugin.custom_classes'
        db.rename_column(u'cmsplugin_textareafieldplugin', 'custom_classes', 'input_html_class')
