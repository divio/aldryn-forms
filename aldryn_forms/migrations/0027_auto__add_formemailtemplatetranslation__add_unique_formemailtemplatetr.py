...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FormEmailTemplateTranslation'
        db.create_table(u'aldryn_forms_formemailtemplate_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('email_body_text', self.gf('django.db.models.fields.TextField')()),
            ('email_body_html', self.gf('djangocms_text_ckeditor.fields.HTMLField')()),
            (u'master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['aldryn_forms.FormEmailTemplate'])),
        ))
        db.send_create_signal(u'aldryn_forms', ['FormEmailTemplateTranslation'])

        # Adding unique constraint on 'FormEmailTemplateTranslation', fields ['language_code', u'master']
        db.create_unique(u'aldryn_forms_formemailtemplate_translation', ['language_code', u'master_id'])

        # Adding model 'FormEmailTemplate'
        db.create_table(u'aldryn_forms_formemailtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal(u'aldryn_forms', ['FormEmailTemplate'])

        # Adding field 'FormPlugin.email_notification_subject'
        db.add_column(u'aldryn_forms_formplugin', 'email_notification_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'FormPlugin.email_notification_template'
        db.add_column(u'aldryn_forms_formplugin', 'email_notification_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_forms.FormEmailTemplate'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'FormEmailTemplateTranslation', fields ['language_code', u'master']
        db.delete_unique(u'aldryn_forms_formemailtemplate_translation', ['language_code', u'master_id'])

        # Deleting model 'FormEmailTemplateTranslation'
        db.delete_table(u'aldryn_forms_formemailtemplate_translation')

        # Deleting model 'FormEmailTemplate'
        db.delete_table(u'aldryn_forms_formemailtemplate')

        # Deleting field 'FormPlugin.email_notification_subject'
        db.delete_column(u'aldryn_forms_formplugin', 'email_notification_subject')

        # Deleting field 'FormPlugin.email_notification_template'
        db.delete_column(u'aldryn_forms_formplugin', 'email_notification_template_id')
    ...
    models = {
        ...
        u'aldryn_forms.formemailtemplate': {
            'Meta': {'object_name': 'FormEmailTemplate'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
        },
        u'aldryn_forms.formemailtemplatetranslation': {
            'Meta': {'unique_together': "[(u'language_code', u'master')]", 'object_name': 'FormEmailTemplateTranslation', 'db_table': "u'aldryn_forms_formemailtemplate_translation'"},
            'email_body_html': ('djangocms_text_ckeditor.fields.HTMLField', [], {}),
            'email_body_text': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            u'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['aldryn_forms.FormEmailTemplate']"})
        },
        u'aldryn_forms.formplugin': {
            'Meta': {'object_name': 'FormPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'custom_classes': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'email_notification_subject': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'email_notification_template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['aldryn_forms.FormEmailTemplate']", 'null': 'True', 'blank': 'True'}),
