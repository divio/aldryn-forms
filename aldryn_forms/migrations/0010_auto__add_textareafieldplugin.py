...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextAreaFieldPlugin'
        db.create_table(u'cmsplugin_textareafieldplugin', (
            ...
            ('text_area_columns', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('text_area_rows', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'aldryn_forms', ['TextAreaFieldPlugin'])


    def backwards(self, orm):
        # Deleting model 'TextAreaFieldPlugin'
        db.delete_table(u'cmsplugin_textareafieldplugin')
