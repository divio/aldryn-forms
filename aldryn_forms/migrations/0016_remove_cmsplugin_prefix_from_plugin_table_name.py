...
class Migration(DataMigration):
    ...
    tables = {
        'cmsplugin_buttonplugin': 'aldryn_forms_button_plugin',
        'cmsplugin_fieldplugin': 'aldryn_forms_fieldplugin',
        'cmsplugin_fieldsetplugin': 'aldryn_forms_fieldsetplugin',
        'cmsplugin_formplugin': 'aldryn_forms_formplugin',
        'cmsplugin_textareafieldplugin': 'aldryn_forms_textareafieldplugin',
    }
