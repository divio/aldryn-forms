...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FieldPlugin.input_html_class'
        db.add_column('cmsplugin_fieldplugin', 'input_html_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'TextAreaFieldPlugin.input_html_class'
        db.add_column(u'cmsplugin_textareafieldplugin', 'input_html_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FieldPlugin.input_html_class'
        db.delete_column('cmsplugin_fieldplugin', 'input_html_class')

        # Deleting field 'TextAreaFieldPlugin.input_html_class'
        db.delete_column(u'cmsplugin_textareafieldplugin', 'input_html_class')
