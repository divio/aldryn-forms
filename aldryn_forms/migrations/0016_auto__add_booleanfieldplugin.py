...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BooleanFieldPlugin'
        db.create_table(u'aldryn_forms_booleanfieldplugin', (
            ...
            ('default_value', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'aldryn_forms', ['BooleanFieldPlugin'])


    def backwards(self, orm):
        # Deleting model 'BooleanFieldPlugin'
        db.delete_table(u'aldryn_forms_booleanfieldplugin')


    models = {
        u'aldryn_forms.booleanfieldplugin': {
            'Meta': {'object_name': 'BooleanFieldPlugin'},
