...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailFieldPlugin.email_subject'
        db.add_column(u'aldryn_forms_emailfieldplugin', 'email_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailFieldPlugin.email_subject'
        db.delete_column(u'aldryn_forms_emailfieldplugin', 'email_subject')
