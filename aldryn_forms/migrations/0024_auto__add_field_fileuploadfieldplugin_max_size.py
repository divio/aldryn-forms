...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileUploadFieldPlugin.max_size'
        db.add_column(u'aldryn_forms_fileuploadfieldplugin', 'max_size',
                      self.gf('sizefield.models.FileSizeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileUploadFieldPlugin.max_size'
        db.delete_column(u'aldryn_forms_fileuploadfieldplugin', 'max_size')
