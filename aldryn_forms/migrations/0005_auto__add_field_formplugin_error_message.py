...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormPlugin.error_message'
        db.add_column(u'cmsplugin_formplugin', 'error_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormPlugin.error_message'
        db.delete_column(u'cmsplugin_formplugin', 'error_message')
