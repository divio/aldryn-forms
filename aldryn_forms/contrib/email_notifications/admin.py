...
from .models import EmailNotificationTemplate


class EmailNotificationTemplateAdmin(TranslatableAdmin):
    ...
    def context_variables(self, obj):
        variables = obj.builtin_context_variables
    ...
    context_variables.short_description = _('available variables')


admin.site.register(EmailNotificationTemplate, EmailNotificationTemplateAdmin)
